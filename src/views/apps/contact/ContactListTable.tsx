  ...
  const columns = useMemo<ColumnDef<ContactType, any>[]>(
    () => [
      ...
      columnHelper.accessor('firstName', {
        ...
        cell: ({ row }) => (
          <div className='flex flex-col'>
            ...
            <Typography variant='caption'>{row.original.role}</Typography>
          </div>
        )
      }),
      columnHelper.accessor('company', {
        ...
        cell: ({ row }) => (
          <div className='flex flex-col'>
            <Typography className='font-medium' color='text.primary'>{row.original.company}</Typography>
            <Typography variant='caption'>{row.original.industry}</Typography>
          </div>
        )
      }),
